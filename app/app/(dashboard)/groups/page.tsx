              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-border/40">
                    <th className="pb-4 font-sans text-[15px] text-slate-500 font-normal">Group No.</th>
                    ...
                    <th className="pb-4 font-sans text-[15px] text-slate-500 font-normal">Schedule</th>
                    <th className="pb-4 font-sans text-[15px] text-slate-500 font-normal">Members</th>
                  </tr>
                </thead>
                <tbody>
                  {groups.length === 0 ? (
                    ...
                    groups.map((group) => (
                      <tr key={group.id} className="border-b border-border/40 last:border-0">
                        <td className="py-5 pr-4">
                          <Link href={`/app/groups/${group.id}`} className="text-[16px] font-sans text-navy-900 hover:text-slate-500 transition-colors">
