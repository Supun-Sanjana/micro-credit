  ...
  return (
    <div className="bg-white rounded-[20px] shadow-subtle-3 p-[32px]">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[15px] text-navy-900 font-sans ml-1">Group Name</label>
          <input 
            required
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[15px] text-navy-900 font-sans ml-1">Meeting Day</label>
          <select 
            value={formData.meetingDay}
            onChange={e => setFormData({...formData, meetingDay: e.target.value})}
            className="bg-white border border-[#ececec] rounded-[16px] px-[16px] py-[14px] text-[16px] text-navy-900 outline-none focus:border-navy-900 appearance-none"
          >
            <option value="" className="text-slate-300">Not Set</option>
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[15px] text-navy-900 font-sans ml-1">Meeting Time</label>
          <input 
            type="time"
