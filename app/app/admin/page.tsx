    ...
    <div className="min-h-screen bg-slate-50 p-6 sm:p-10 font-sans text-navy-900">
      <div className="max-w-[1200px] mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Link href="/app/admin/orgs" className="bg-white p-5 rounded-[20px] border border-[#ececec] shadow-subtle-3 hover:border-navy-900 transition-colors group flex flex-col gap-3">
            <div className="h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-navy-900 group-hover:bg-navy-900 group-hover:text-white transition-colors">
              <Building2 className="h-5 w-5" />
            </div>
            <div>
              <div className="font-medium text-[15px]">Organizations</div>
              <div className="text-[13px] text-slate-500">Manage tenant accounts</div>
            </div>
          </Link>

          <Link href="/app/admin/claims" className="bg-white p-5 rounded-[20px] border border-[#ececec] shadow-subtle-3 hover:border-navy-900 transition-colors group flex flex-col gap-3 relative">
            <div className="h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-navy-900 group-hover:bg-navy-900 group-hover:text-white transition-colors">
            ...
            <div>
              ...
              <div className="text-[13px] text-slate-500">Verify bank transfers</div>
            </div>
          </Link>

          <Link href="/app/admin/plans" className="bg-white p-5 rounded-[20px] border border-[#ececec] shadow-subtle-3 hover:border-navy-900 transition-colors group flex flex-col gap-3">
            <div className="h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-navy-900 group-hover:bg-navy-900 group-hover:text-white transition-colors">
              <ListTodo className="h-5 w-5" />
            </div>
            <div>
              <div className="font-medium text-[15px]">Subscription Plans</div>
              <div className="text-[13px] text-slate-500">Manage pricing tiers</div>
            </div>
          </Link>

          <Link href="/app/admin/audit-logs" className="bg-white p-5 rounded-[20px] border border-[#ececec] shadow-subtle-3 hover:border-navy-900 transition-colors group flex flex-col gap-3">
            <div className="h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-navy-900 group-hover:bg-navy-900 group-hover:text-white transition-colors">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <div>
              <div className="font-medium text-[15px]">Audit Logs</div>
              <div className="text-[13px] text-slate-500">View platform activity</div>
            </div>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {/* Tenant Status */}
          <div className="bg-white p-8 rounded-[24px] border border-[#ececec] shadow-subtle-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-slate-50 rounded-[16px]">
                <div className="text-[13px] text-slate-500 font-medium uppercase tracking-wider mb-1">Total Orgs</div>
          ...
          <div className="bg-white p-8 rounded-[24px] border border-[#ececec] shadow-subtle-3 flex flex-col justify-between gap-6">
            <div>
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="text-[14px] text-slate-500 mt-2">
            ...
            <div className="pt-6 border-t border-[#ececec]">
              ...
              <div className="flex items-end gap-2">
                ...
                <div className="text-[15px] text-slate-500 font-medium pb-[2px]">GB</div>
              </div>
            </div>
          </div>
        </div>
