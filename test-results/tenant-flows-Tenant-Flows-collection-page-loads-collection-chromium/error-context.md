...
- Name: tenant-flows.spec.ts >> Tenant Flows >> collection page loads /collection
- Location: tests\e2e\tenant-flows.spec.ts:56:7
...
```ts
  ...
  25 |     await page.goto('/app/members');
  26 |     await expect(page).toHaveURL('/app/members', { timeout: 15000 });
  ...
  33 |     await page.goto('/app/loans');
  34 |     await expect(page).toHaveURL('/app/loans', { timeout: 15000 });
  ...
  41 |     await page.goto('/app/branches');
  42 |     await expect(page).toHaveURL('/app/branches', { timeout: 15000 });
  ...
  49 |     await page.goto('/app/centres');
  50 |     await expect(page).toHaveURL('/app/centres', { timeout: 15000 });
  ...
  57 |     await page.goto('/app/collection');
  58 |     await expect(page).toHaveURL('/app/collection', { timeout: 15000 });
...
> 60 |     await expect(page.locator('main')).toBeVisible();
  ...
  65 |     await page.goto('/app/reports');
  66 |     await expect(page).toHaveURL('/app/reports', { timeout: 15000 });
  ...
  73 |     await page.goto('/app/settings/billing');
  74 |     await expect(page).toHaveURL('/app/settings/billing', { timeout: 15000 });
